...
def load_settings() -> Settings:
    ...
    # Preserve compatibility with .env files generated by versions that
    # incorrectly documented https://arena.ai/api as the chat base URL.
    if base_url in {"https://arena.ai/api", "https://www.arena.ai/api"}:
    ...
    return Settings(
        ...
        # Arena can require a short-lived, user-obtained reCAPTCHA v3 token.
        # This value is optional; when rejected the API returns a clear error.
        recaptcha_v3_token=os.getenv("ARENA_RECAPTCHA_V3_TOKEN", "").strip(),
    )
